...
Definition greater7 (n : nat) : bool :=
  leb 7 n.

Definition filter_even_gt7 (l : list nat) : list nat :=
  filter greater7 (filter (evenb) (l)).
...
(* Yes, something that can generally apply to multiple different data types like lists of different containers *)
(** [] *)
