(** * Logic: Logic in Coq *)
Add LoadPath "/Users/anikaitsingh/Desktop/coqSoftwareFoundations/chapter5".
...
Fact not_implies_our_not : forall (P:Prop),
  ~ P -> (forall (Q:Prop), P -> Q).
Proof.
  intros p. unfold not. intros H. intros Q. intros l. contradiction.
Qed. 
...
Theorem contrapositive : forall (P Q : Prop),
  (P -> Q) -> (~Q -> ~P).
Proof.
intros P Q H. unfold not. intros nQ. intros s. apply nQ. apply H. apply s. Qed.
...
Theorem not_both_true_and_false : forall P : Prop,
  ~ (P /\ ~P).
Proof.
intros P. unfold not. intros H. inversion H. contradiction. 
Qed.
(** [] *)
...
* intros. destruct H. exists x. right. apply H.
Qed.
